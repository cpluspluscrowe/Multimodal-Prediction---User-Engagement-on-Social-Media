...
class Static:
    ...
    limit = 10000  # len(os.listdir("../Image_CNN/images"))
    group_size = limit
...
newModel = load_model(
    r"/Users/ccrowe/Documents/Thesis/facebook_api/Notebooks/Combine_Keras_Models/Combined_Model_getCommentCount.h5")
...
for post1_tuple, post2_tuple in combinations(list(zip(truths, predictions)), 2):
    ...
    if truth1 != truth2:
        if abs(post1.truth - post2.truth) > 60:
            incorrect += 1
    else:
        correct += 1
