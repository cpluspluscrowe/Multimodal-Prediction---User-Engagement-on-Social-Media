...
newModel = load_model(
    r"/Users/ccrowe/Documents/Thesis/facebook_api/Notebooks/Combine_Keras_Models/Combined_Model_getShareCount.h5")
for trainX_image, trainX_message, trainY, testX_image, testX_message, testY in get_data():
    ...
    for post1_tuple, post2_tuple in combinations(list(zip(truths, predictions)), 2):
        ...
        if abs(post1.truth * 100 - post2.truth * 100) > 1:
            ...
            if truth1 != truth2:
                ...
                correct += 1
    print("Correct: ", correct, " Incorrect: ", incorrect, " Percent Correct: ", correct / (correct + incorrect + 1),
