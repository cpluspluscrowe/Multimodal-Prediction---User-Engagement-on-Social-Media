...
model = load_model(
    "/Users/ccrowe/Documents/Thesis/facebook_api/Notebooks/Combine_Keras_Models/Combined_Model_getShareCount.h5")
...
bins = numpy.linspace(0, 250, 100)

pyplot.hist(flatten_predictions, bins, alpha=0.5, label='Share Count Prediction')
pyplot.hist(testY, bins, alpha=0.5, label='Share Count', )
pyplot.title("Histogram of Prediction Share Count\non Actual Share Count Histogram")
pyplot.legend(loc='upper right')
pyplot.xlabel("Share Count")
pyplot.ylabel("Bin Count")
pyplot.savefig('ShareCountPredictionHistogram.png')
