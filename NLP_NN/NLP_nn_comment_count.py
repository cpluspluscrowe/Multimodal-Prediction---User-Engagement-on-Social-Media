...
postData = MessageGetter.facebookDb.selectCommentData()
...
model.add(Dense(units=64, activation='relu', input_dim=len(vectorizer.get_feature_names())))
...
model_name = '/Users/ccrowe/Documents/Thesis/facebook_api/Notebooks/NLP_NN/nlp_getCommentCount.h5'
...
correct = 0
cnt = 0
for post1_tuple, post2_tuple in combinations(list(zip(truths, predictions)), 2)[:10000]:
